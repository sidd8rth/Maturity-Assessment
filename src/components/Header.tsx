        ...
        <div className="flex items-center gap-2 sm:gap-2.5 flex-shrink-0">
          {onRetake && (
            <button
              type="button"
              onClick={onRetake}
              className="inline-flex items-center gap-1.5 border border-border hover:border-airtel-navy text-ink-sub hover:text-ink-dark hover:bg-bg-secondary px-2.5 sm:px-3.5 py-2 rounded-lg text-[0.8rem] sm:text-[0.85rem] font-semibold transition-colors whitespace-nowrap"
