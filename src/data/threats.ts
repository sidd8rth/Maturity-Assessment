...
export const TIER_THREATS: Record<Tier, ThreatInfo[]> = {
  ...
  Established: [
    { icon: '🕵️', name: 'Advanced persistent threats (APT)', desc: 'Groups like APT29 or Lazarus operate over months using low-and-slow techniques that fly under standard SIEM rules. By the time you notice, they\'ve already mapped your network.' },
  ...
  Advanced: [
    ...
    { icon: '🤖', name: 'AI-powered adversarial attacks',  desc: 'AI now scans, phishes, and writes exploit code faster than human analysts can review the output. Continuous automated red-teaming is the only realistic way to keep pace.' },
  ],
};
