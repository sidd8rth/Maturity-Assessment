...
export const QUESTIONS: Question[] = [
  ...
  },
  {
    ...
    q: 'How are you tracking compliance with Indian regulations? (DPDPA, RBI, SEBI, IRDAI, CERT-In 6-hour reporting)',
    terms: [
      { term: 'DPDPA',     def: "Digital Personal Data Protection Act (2023). India's new privacy law mandating data handling rules and breach notification obligations for all organisations processing Indian personal data." },
    ...
    opts: [
      ...
      { t: "I'm not sure how we track regulatory compliance",                                sub: "No clear ownership of compliance I'm aware of, risky given DPDPA and CERT-In obligations",                                 plainSub: 'If nobody can describe how compliance is tracked, the next audit (or DPDP/CERT-In incident) is a serious risk.', s: 1, isUnsure: true },
    ],
  },
  {
    domain: 'Governance & Compliance',
  ...
  },
  {
    ...
    terms: [
      ...
      { term: 'PII',  def: 'Personally Identifiable Information, any data that can identify a person (name, phone, Aadhaar, email). Subject to DPDPA obligations in India.' },
    ],
    opts: [
